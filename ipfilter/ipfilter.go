...
func init() {
	casket.RegisterPlugin("ipfilter", casket.Plugin{
		ServerType: "http",
		Action:     Setup,
	})
}
...
func ipfilterParseSingle(config *IPFConfig, c *casket.Controller) (IPPath, error) {
	var cPath IPPath
...
func ipfilterParse(c *casket.Controller) (IPFConfig, error) {
